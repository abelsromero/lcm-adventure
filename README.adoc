...
. task: important stuff that must be done soon. Pretty similar to _help wanted_ but for more prioritary tasks.
. open discussion: open questions about the design of the solution. The main intent for this issues is to
